...
class Profile(models.Model):
    ...
    identity_type = models.CharField(choices=IDENTITY_TYPE, default="national_id_card", max_length=100, null=True,
                                     blank=True)
    # utilise  la function user_directory_path pour l'image identity
...
# Function pour creer automatiquement un profil lorsqu'on crèe un utilisateur
def create_user_profile(sender, instance, created, **kwargs):
    if created:
        Profile.objects.create(user=instance)


#Function pour sauvegarder un profil
